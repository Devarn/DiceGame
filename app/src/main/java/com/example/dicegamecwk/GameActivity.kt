...
class GameActivity : AppCompatActivity() {
    ...
    var scorePlayer = 0//core of the player
    ...
    val dicePicArray = intArrayOf(
        R.drawable.die1, R.drawable.die2, R.drawable.die3, R.drawable.die4,
...
first as usual on the first throw random dice will be generated

then it checks if the current sum of the rolled dice and adds to the score and compares
if it is enough to win in this case it will only re roll die with value one to be safe


if the score of the computer is greater than or equal to the score of the player,
it will take less risk and only roll dice with values 1 and 2. this is done for less risk of losing


if the score of the computer is less than the score of the player,
it will take more risks by trying to re roll anything below die value 4 (1,2,3), as it is in a losing
state it will try more risk in the hopes of scoring a larger sum

the above conditions will run in a loop twice and so will optimize the chances of the computer to win


advantages

the strategy is a low risk one where it does not put in much risk if it is high or in the event
of a lower score will try to maximise chances of a higher score.

always if die value is 1 it is being re rolled as it will not have any negative outcomes


disadvantages
as it re rolls more dice in a lower score state there is a chance for even lower
die values to come up so decreasing its chance of winning further.
the strategy relies on getting its first throw as a high value as only then can it maximise its
chance of winning
...
single line take    android:layout_gravity="center" to center elements


https://stackoverflow.com/questions/23517879/set-background-color-programmatically
code in the above was taken to add a color border to an image view and set its padding
it was used in auto highlight function and etc


https://stackoverflow.com/questions/5944987/how-to-create-a-popup-window-popupwindow-in-android
above code was take to understand how to add an xml file and use it as the background
of pop window.
additionally the setups to create a pop up windows was understood


https://www.youtube.com/watch?v=TcTgbVudLyQ&t=185s
understood above concept and used it to apply it in the on save and restore instance state



https://stackoverflow.com/questions/63738449/play-a-sound-by-clicking-a-button
used the above code replacing sound file to play dice roll sounds on throw


https://www.geeksforgeeks.org/switch-in-kotlin/
used the above to understand how switch button works and implemented with my own conditions
